...
function BreadcrumbList({ className, ...props }: React.ComponentProps<'ol'>) {
  return (
    <ol data-slot="breadcrumb-list" className={cn('flex flex-wrap items-center gap-2 text-sm', className)} {...props} />
  );
}
...
function BreadcrumbLink({
  ...
  return (
    <Comp
      ...
      className={cn('hover:text-primary text-gray-600 transition-colors', className)}
      {...props}
    />
  );
}
