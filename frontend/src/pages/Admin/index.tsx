    ...
    <>
      <section className="mt-4 mb-6">
        ...
        <div className="mb-5 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 [&>div]:bg-white">
          <div onClick={() => navigate('/admin/users')} className="cursor-pointer rounded-xl px-4 py-3 shadow-xs">
          ...
          <div onClick={() => navigate('/admin/rooms')} className="cursor-pointer rounded-xl px-4 py-3 shadow-xs">
