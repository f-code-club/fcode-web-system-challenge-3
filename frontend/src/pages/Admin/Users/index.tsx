    ...
    <div className="overflow-hidden rounded-lg border border-gray-200/70 bg-white shadow-xs">
      <div className="border-b border-gray-200/70 bg-linear-to-r from-gray-50/80 to-white px-5 py-4 sm:px-6 sm:py-5">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-base font-semibold tracking-tight text-gray-900 sm:text-lg">Danh sách Users</h3>
                ...
                <tr key={user.id} className="transition-colors hover:bg-gray-50/50">
                  ...
                  <td className={`px-4 py-3.5 text-sm whitespace-nowrap text-gray-700 sm:px-6 sm:py-4`}>
                    ...
                    {user.candidate?.major && (
                      <p className="mt-0.5 text-xs text-gray-600">Ngành: {user.candidate?.major}</p>
                    )}
                  </td>
    ...
    <div className="container mx-auto py-6">
      ...
      <Tabs defaultValue="all" className="space-y-4">
        <TabsList className="grid w-full grid-cols-5 border border-gray-200 bg-white">
          ...
          <TabsTrigger value="CANDIDATE" className="data-[state=active]:bg-primary data-[state=active]:text-white">
            Thí sinh ({filterUsersByRole('CANDIDATE').length})
          </TabsTrigger>
          <TabsTrigger value="MENTOR" className="data-[state=active]:bg-primary data-[state=active]:text-white">
            Mentor ({filterUsersByRole('MENTOR').length})
          </TabsTrigger>
          <TabsTrigger value="JUDGE" className="data-[state=active]:bg-primary data-[state=active]:text-white">
