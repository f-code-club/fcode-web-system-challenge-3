            ...
            <div key={submission.id} className="rounded-lg border border-gray-200/80 bg-white p-4">
              ...
              <div className="mb-3 flex items-center justify-between border-b border-gray-100 pb-3">
                <div className="flex items-center gap-2">
                  <span className="text-base font-semibold text-gray-900">Lần #{submissions.length - index}</span>
                  {isLatest ? (
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-sm font-medium text-gray-900">{Helper.timeAgo(submission.submittedAt)}</span>
                  </div>
