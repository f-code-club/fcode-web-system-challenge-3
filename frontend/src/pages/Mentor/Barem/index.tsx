        ...
        >
          {candidates?.candidates.map((candidate) => (
            ...
            >
              ...
              <span className="flex-1 cursor-pointer text-sm font-medium text-gray-900">{candidate.user.fullName}</span>
            </label>
          ))}
        </RadioGroup>
      </div>
                    ...
                    return subPartitions.map((subPart, subIndex) => {
                      ...
                      const row = (
                        <tr key={scoreKey} className="divide-x divide-gray-100 transition-colors hover:bg-gray-50/50">
                          ...
                          {isFirstSubPart && (
                            <td rowSpan={criteriaRowSpan} className="bg-gray-50/70 px-4 py-4 text-center">
                              <span className="text-sm font-semibold text-gray-800">{partition.criteria}</span>
                            </td>
                          )}
