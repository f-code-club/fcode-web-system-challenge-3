import { Calendar, Clock, CheckCircle, Video, Lightbulb, BookOpen } from "lucide-react";
...
const SchedulePresent = ({ data }: Props) => {
    ...
    return (
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-6">
            ...
            <div className="col-span-4 overflow-hidden rounded-lg border border-teal-200/60 bg-gradient-to-br from-teal-50/50 to-white shadow-xs">
                ...
                {registrationData.officialSlot.confirmed && registrationData.officialSlot.confirmedSlot ? (
                    <div className="space-y-3 px-4 py-3">
                        ...
                        <div className="rounded-lg border border-teal-200/50 bg-teal-50/30 p-2.5 text-center">
                            <p className="text-xs font-medium text-teal-800">
                                ✓ Lịch thuyết trình chính thức đã được BTC sắp xếp
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 px-4 py-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="rounded-lg bg-blue-50/50 px-2.5 py-2 text-center">
                                <p className="text-xs font-bold text-blue-700">BTC sẽ chọn 1 khung giờ phù hợp nhất</p>
                            </div>
                        </div>
                    </div>
                ) : (
            ...
            {/* Thuyết trình thử */}
            <div className="col-span-2 h-fit overflow-hidden rounded-lg border border-amber-200/60 bg-gradient-to-br from-amber-50/50 to-white shadow-xs">
