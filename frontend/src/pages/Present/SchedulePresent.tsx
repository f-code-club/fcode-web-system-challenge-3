import { BookOpen, Calendar, CheckCircle, Clock, MapPinHouse, Video } from 'lucide-react';
          ...
          <div className={`space-y-3 px-4 py-3`}>
            <div className="grid grid-cols-3 gap-2">
              <div className="flex flex-col items-center rounded-lg bg-amber-50/50 p-2 text-center">
                ...
                <p className="text-xs font-medium text-gray-500">Ngày</p>
                <p className="mt-0.5 text-xs font-bold text-gray-900">{registrationData.trialSlot.date}</p>
              </div>
              <div className="flex flex-col items-center rounded-lg bg-amber-50/50 p-2 text-center">
                <Clock className="mb-1 h-3.5 w-3.5 text-amber-600" />
                <p className="text-xs font-medium text-gray-500">Giờ</p>
                <p className="mt-0.5 text-xs font-bold text-gray-900">{registrationData.trialSlot.time}</p>
              </div>
              <div className="flex flex-col items-center rounded-lg bg-amber-50/50 p-2 text-center">
              ...
              <div className="rounded-lg border border-amber-200/50 bg-amber-50/30 p-2.5">
                <div className="flex items-center gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <img src="/icon-new.gif" alt="important" className="ml-1 inline-block h-4 w-8" />
                  </div>
                </div>
              </div>
            )}
